...
<div id="header">
  <span><a style="text-decoration: none;" href="#panel-example" class="toggle-panel"><i id="burger" class="fa fa-bars white"></i></a><h1>Minecraft</h1></span>
</div>
...
<div id="hero" style="background-image: url('images/scaled_minecraft.jpg'); background-repeat: no-repeat; background-size: cover;"></div>
<div class=grid>
<div class="card">
  <div class="cardHeader"><h2>Bukkit Server</h2></div>
  <div class="cardImgCont">
     <div class="cardImg">
        <img style="width: 100%;" src="images/bukkit.png">
     </div>
	<div class=cardContent>
		<div class=cardIcons style='float: left;'>
			<h4 style='margin: 0px;'>Last Used
        		Oct 18 13:52			</h4>
		</div>
        	<div id="old" class="cardBox">
			<div id="oldtext" class="cardIcons">TOGGLE</div>
		</div>
     	</div>
    </div>
</div>
...
<div class="card">
  <div class="cardHeader">
    ...
    <div class="cardImgCont">
     <div class="cardImg">
        <img style="width: 100%;" src="images/vanilla.jpg">
     </div>
        <div class=cardContent><div class=cardIcons style='float: left;'>
                <h4 style='margin: 0px;'>Last Used
                Aug 22 12:32                </h4>
        </div>
        <div id="new" class="cardBox"><div id="newtext" class="cardIcons">TOGGLE</div></div>
     </div>
    </div>
</div>
