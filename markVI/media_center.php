...
<div id="header">
  <span><a style="text-decoration: none;" href="#panel-example" class="toggle-panel"><i id="burger" class="fa fa-bars white"></i></a><h1>Media Center</h1></span>
</div>
...
<div id="hero" style="background-image: url('images/scaled_media.jpg'); background-size: cover; background-repeat: no-repeat;"></div>
<div class=grid>
<div class="card">
...
<div class="cardContent">
   <div id="power" class="cardBox" onclick="changeOrange(this)"><div class="cardIcons">POWER</div></div>

   <a href="yatse://command/show/remote"><div id="remote" onclick="changeOrange(this)" class="cardBox"><div class="cardIcons">REMOTE</div></div></a>
...
<div class="card">
  <div class="cardHeader">
	...
	<center>
		<img src="../automation/images/movie1.jpg?=1">
		<img src="../automation/images/movie2.jpg?=2">
		<img src="../automation/images/movie3.jpg?=3">
	</center>
	</div>
    </div>
</div>
...
<div class="card">
  <div class="cardHeader">
	...
	<div class="seperator2"></div>
    <div class="cardContent">
	<a href="show1.php"><div class="mediaSection">
	<center>
<img src='images/tv1.jpg'><img src='images/tv2.jpg'><img src='http://www.thetvdb.com/banners/_cache/fanart/original/95011-1.jpg'>	</center>
	</div></a>
    </div>
</div>
</div>
