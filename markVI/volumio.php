...
<div id="header">
  <span style='margin:0'><a style="text-decoration: none;" href="#panel-example" class="toggle-panel">
	<i id="burger" class="fa fa-bars white"></i>
  </a><h1>Volumio</h1></span>
</div>
...
<div style='height:11vh;width:100vw;margin:0;position:relative;padding:0'></div>

<div style='min-height: 78.5vh;'><div class=card><div class=cardHeader>There's No Place Like Home<div class=seperator2></div></br><div class=cardImgCont><div class=cardImg><img style='width: 100%; height: auto;' src='images/standby.jpg'></div></div><div class=cardContent><div class=cardIcons>You have to be home to use this one. :\</div></div></div></div></div>
<div id=overlay></div>
</div>
