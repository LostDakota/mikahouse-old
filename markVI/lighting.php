...
<div id="header">
  <span><a style="text-decoration: none;" class="toggle-panel"><i id="burger" class="fa fa-bars white"></i></a><h1>Controls</h1></span>
</div>
...
<div id="hero" style="background-image: url('images/scaled_lighting.jpg'); background-repeat: no-repeat; background-size: cover;"></div>

<div style="min-height: 49.55vh;">
<div class=grid>
<div class=card><div class=cardHeader><h2>Living Room</h2></div><div class=seperator2></div><div class=paper-toggle><input type=checkbox name=Light id='1'class=switch  onchange='updateValue(this.id)'><label for=1>Light</label></div></div><div class=card><div class=cardHeader><h2>Garage</h2></div><div class=seperator2></div><div class=paper-toggle><input type=checkbox name=Door id='5'class=switch checked onchange='updateValue(this.id)'><label for=5>Door</label></div><div class=paper-toggle><input type=checkbox name=Radio id='4'class=switch  onchange='updateValue(this.id)'><label for=4>Radio</label></div></div><div class=card><div class=cardHeader><h2>Back Room</h2></div><div class=seperator2></div><div class=paper-toggle><input type=checkbox name=Lamp id='3'class=switch  onchange='updateValue(this.id)'><label for=3>Lamp</label></div></div>
</div>
